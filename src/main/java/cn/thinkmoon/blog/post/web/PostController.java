package cn.thinkmoon.blog.post.web;
...
import cn.thinkmoon.blog.post.service.PostService;
...
public class PostController {
    ...
    public boolean updatePost(
            @RequestBody Map body,
            @RequestAttribute("user_info") UserPO user) {
        return postService.updatePost((int) body.get("cid"), user.getId(), (String) body.get("title"), (String) body.get("text"), (String) body.get("category_id"));
    }
